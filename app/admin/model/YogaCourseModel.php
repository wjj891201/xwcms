...
class YogaCourseModel extends Model
{

    protected $table = "xw_yoga_course";
    ...
    public function getArticleList($where, $param)
    {
        ...
        $list = self::where($where)
                ...
                ->alias('a')
                ->join('yoga_cate c', 'a.cate_id = c.id')
     ...
     * @param $param
     */
    public function addYogaCourse($param)
    {
        $insertId = 0;
        try
        {
     ...
     * @param $param
     */
    public function editYogaCourse($param)
    {
        try
        {
     ...
     * @param $id
     */
    public function getYogaCourseById($id)
    {
     ...
     * @return array
     */
    public function delYogaCourseById($id, $type = 0)
    {
        if ($type == 0)
        {
            //逻辑删除
